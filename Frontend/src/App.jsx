  ...
  return (
    <div style={containerStyle}>
      ...
      {activeTab === 'ons' && (loading.ons ? <p>Cargando ONs...</p> : renderScatterChart())}
       ...
       <footer style={{ marginTop: '30px', color: '#475569', fontSize: '0.8rem', textAlign: 'center' }}>
         <div>Backend Activo • Puerto 8000 • Datos de data912.com</div>
         <div style={{ marginTop: '5px', opacity: 0.7 }}>URL API: {API_URL}</div>
       </footer>
